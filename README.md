...
---
- 2026.6.27
    - 增加`PP-DocLayoutV2`版面检测逻辑，提升ocr识别精度
    - 将版面检测模型接入pipeline，优化OCR识别结果
    - 修复部分bug
- 2026.6.23
    - 初始化发布 
---
...
## 版面检测模型
PP-DocLayoutV2 onnx模型[下载地址](https://huggingface.co/alex-dinh/PP-DocLayoutV2-ONNX/tree/main)，目前部署在主控端，占用主控端的资源。
